...
LOG_FILE="${LOG_PATH}/${SLURM_JOB_ID}-spark-runtime-${TIMESTAMP}.log"
ERR_FILE="${LOG_PATH}/${SLURM_JOB_ID}-spark-runtime-${TIMESTAMP}.err"
...
OUTPUT_PATH="/work/projects/polyullm/wtf/data/Nemotraon-CC-Math-v1-dedup-a"
FILE_TYPE="parquet"
TEXT_KEY="text"
