...
DEFAULT_DRIVER_MEMORY="32G"
DEFAULT_DRIVER_MEMORY_OVERHEAD="8G"
DEFAULT_SPARK_UI_SHOW_CONSOLE_PROGRESS="false"
...
export DRIVER_MEMORY="${DRIVER_MEMORY:-$DEFAULT_DRIVER_MEMORY}"
export DRIVER_MEMORY_OVERHEAD="${DRIVER_MEMORY_OVERHEAD:-$DEFAULT_DRIVER_MEMORY_OVERHEAD}"
export SPARK_UI_SHOW_CONSOLE_PROGRESS="${SPARK_UI_SHOW_CONSOLE_PROGRESS:-$DEFAULT_SPARK_UI_SHOW_CONSOLE_PROGRESS}"
export SPARK_LOG_LEVEL="${SPARK_LOG_LEVEL:-$DEFAULT_SPARK_LOG_LEVEL}"
